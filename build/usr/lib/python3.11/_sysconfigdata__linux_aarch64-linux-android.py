...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang '
              '-shared '
              '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
              '-pie',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CCSHARED': '',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'CONFIGURE_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                      '-pie',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--host=aarch64-linux-android' '--build=x86_64-linux-gnu' "
                "'ac_cv_file__dev_ptmx=yes' 'ac_cv_file__dev_ptc=no' "
                "'ac_cv_buggy_getaddrinfo=no' '--prefix=/usr' "
                "'--enable-shared' '--with-ensurepip' '--disable-ipv6' "
                "'--with-build-python' 'build_alias=x86_64-linux-gnu' "
                "'host_alias=aarch64-linux-android' "
                "'PKG_CONFIG_LIBDIR=/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib/pkgconfig' "
                "'CC=/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang' "
                "'CFLAGS=-fPIC' "
                "'LDFLAGS=-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib "
                "-pie' "
                "'CPPFLAGS=-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include' "
                "'CPP=/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang "
                "-E'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/python3-android/src/Python-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/python3-android/src/Python-3.11.6/lcov-report',
 ...
 'INSTSONAME': 'libpython3.11.so',
 'IO_H': 'Modules/_io/_iomodule.h',
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang++ '
                '-shared',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'LIBM': '-lm',
 ...
 'LIBPL': '/usr/lib/python3.11/config-3.11',
 ...
 'LIBS': '-ldl',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang',
 ...
 'MAINCC': '/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'MODULE_BINASCII_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'MODULE_ZLIB_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib    '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'MODULE__LZMA_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                         '-llzma',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib   '
                        '-lssl -lcrypto',
 ...
 'MODULE__UUID_CFLAGS': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                         '-luuid',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'OPENSSL_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/python3-android/src/Python-3.11.6 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/python3-android/src/Python-3.11.6/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -std=c11 '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  -I./Include/internal -I. '
                             '-I./Include '
                             '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include '
                             '-DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC',
 'PY_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -I./Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -std=c11 '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I./Include/internal -I. -I./Include '
                   '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                    '-pie',
 'PY_CPPFLAGS': '-I. -I./Include '
                '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
               '-pie',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib '
                     '-pie',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
 'PY_SQLITE_HAVE_SERIALIZE': 0,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -fPIC -std=c11 '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include '
                        '-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include',
 ...
 'READELF': '/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-readelf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/python3-android/src/Python-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/python3-android/src/Python-3.11.6/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-android '
               'python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/python3-android/src/Python-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/python3-android/src/Python-3.11.6/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-android '
 ...
 'abs_builddir': '/python3-android/src/Python-3.11.6',
 'abs_srcdir': '/python3-android/src/Python-3.11.6',
