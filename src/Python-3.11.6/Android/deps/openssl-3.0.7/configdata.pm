...
our %config = (
    ...
    "CPPFLAGS" => [
        "-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include"
    ],
    "CPPINCLUDES" => [],
    "CXX" => "/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang++",
    "CXXFLAGS" => [
        "-Wall -O3"
    ],
    ...
    "LDFLAGS" => [
        "-L/python3-android/src/Python-3.11.6/Android/sysroot/usr/lib -pie"
    ],
    "LDLIBS" => [],
    "PERL" => "/usr/bin/perl",
    "RANLIB" => ":",
    ...
    "perlenv" => {
        ...
        "CFLAGS" => "-fPIC",
        "CPPFLAGS" => "-I/python3-android/src/Python-3.11.6/Android/sysroot/usr/include",
        "CROSS_COMPILE" => undef,
        "CXX" => "/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android23-clang++",
        "CXXFLAGS" => undef,
        "HASHBANGPERL" => undef,
...
unless (caller) {
    ...
    use lib '/python3-android/src/Python-3.11.6/Android/deps/openssl-3.0.7/util/perl';
    use OpenSSL::fallback '/python3-android/src/Python-3.11.6/Android/deps/openssl-3.0.7/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/python3-android/src/Python-3.11.6/Android/deps/openssl-3.0.7/Configurations';
        use gentemplate;
