...
BEGIN {
    ...
    require '/python3-android/src/Python-3.11.6/Android/deps/openssl-3.0.7/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/python3-android/src/Python-3.11.6/Android/deps/openssl-3.0.7/test/fips-and-base.cnf';
    shift;
